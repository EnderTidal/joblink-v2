...
<style>
  ...
  * { box-sizing:border-box; margin:0; }
  ...
  .drag-grip { display:none; font-size:20px; color:var(--text-muted); cursor:grab; user-select:none; position:absolute; left:6px; top:12px; }
  .reorder-mode .drag-grip { display:block !important; }
  .reorder-mode .job-card { padding-left:30px; }
